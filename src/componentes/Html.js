...
const texto = "Web desarrollada utilizando solo HTML y CSS para una empresa de diseño de moda. Full responsive e incluye Bootstrap, Sass y otros frameworks y librerías. Click para dirigirte a la página. // Web developed using only HTML and CSS for a fashion design project. It includes Bootstrap, Sass and other frameworks and libraries. Full responsive. Click here to navigate.";
